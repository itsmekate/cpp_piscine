...
int	main(void)
{
	...
	NinjaTrap chuck = NinjaTrap("Chuck");
	...
	std::cout << "Ninja Robot is named: " << chuck.getName() << std::endl;
	std::cout << "Ninja Robots' level is: " << chuck.getLevel() << std::endl;
	std::cout << "Ninja Robots' energy: " << chuck.getEnergyPoints() << std::endl;
	std::cout << "Ninja Robots' HP: " << chuck.getHitPoints() << std::endl;
	
	chuck.rangedAttack("Andy");
	chuck.ninjaShoebox(bonnie);
	chuck.ninjaShoebox(joe);

	std::cout << "Ninja Robots' level is: : " << chuck.getLevel() << std::endl;
	std::cout << "Ninja Robots' energy: " << chuck.getEnergyPoints() << std::endl;
	std::cout << "Ninja Robots' HP: " << chuck.getHitPoints() << std::endl;

	chuck.beRepaired(100);
	chuck.takeDamage(120);
